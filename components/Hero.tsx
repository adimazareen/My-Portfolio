...
const Hero = ({ mainData }: HeroProps) => {
    ...
    return (
        <section id='home' className={`${theme === 'dark' && "bg-grey-900"} relative min-h-screen w-full mx-auto overflow-hidden`}>
            ...
            <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-500/20 blur-[150px] rounded-full"></div>

            <div className="py-16 lg:py-40 flex flex-col-reverse lg:flex-row justify-between items-center gap-16 lg:px-20">

            <div className="flex flex-col gap-5 text-left lg:w-[45%] mx-4 md:mx-6 xl:mx-0 justify-center">
                ...
                {/* Full Name - Always One Line */}
                <h1 className="font-bold leading-tight whitespace-nowrap text-[30px] md:text-[40px] lg:text-[48px]">
                    Shaikh Adima Zareen
                </h1>

                {/* I am into */}
                <div className="flex items-center gap-2 text-xl md:text-2xl whitespace-nowrap">
                    <span>I am into</span>
                    ...
                    <Typewriter
                        options={{
                            ...
                            delay: 40,
                            wrapperClassName:
                                "text-violet-700 dark:text-violet-500 font-semibold inline-block min-w-[420px]",
                            cursorClassName:
                ...
                {/* Description */}
                <p className="max-w-xl text-base md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                    {shortDesc}
                </p>

                <div className="flex gap-3 flex-wrap">
                    <ScrollLink
                        className="w-fit text-sm md:text-base py-2 px-5 cursor-pointer flex items-center gap-1 rounded-md bg-violet-600 hover:bg-violet-700 text-white"
                        to={"about"}
                        offset={-60}
                        smooth={true}
                        duration={500}
                    ...
                    <a
                        ...
                        download
                        className="w-fit text-sm md:text-base py-2 px-5 rounded-md border-2 border-violet-600 text-violet-600 hover:bg-violet-600 hover:text-white transition-all"
                    >
                        Download Resume
                    </a>
                </div>
                ...
                <div className="relative mx-auto lg:mx-0 mt-12 md:mt-16 lg:mt-0">
                    ...
                    {/* Purple glow */}
                    <div className="absolute w-72 h-72 md:w-[340px] md:h-[340px] rounded-full bg-violet-500/20 blur-3xl"></div>

                    {/* Purple border circle */}
                    <div className="w-64 h-64 md:w-[320px] md:h-[320px] rounded-full border-[6px] border-violet-500 overflow-hidden bg-white dark:bg-grey-800 shadow-2xl z-10">
                    ...
                    {/* Python */}
                    <div className="absolute top-0 -left-20 lg:-left-10 w-14 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full shadow-xl flex items-center justify-center">
                        <Image
                            alt="Python"
                    ...
                    {/* Flask */}
                    <div className="absolute top-0 -right-14 lg:-right-10 w-14 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full shadow-xl flex items-center justify-center">
                        <Image
                            alt="Flask"
                    ...
                    {/* HTML */}
                    <div className="absolute bottom-20 -left-20 lg:-left-17 w-14 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full shadow-xl flex items-center justify-center">
                        <Image
                            alt="HTML"
                    ...
                    {/* OpenCV */}
                    <div className="absolute bottom-20 -right-10 lg:-right-20 w-14 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full shadow-xl flex items-center justify-center">
                        <Image
                            alt="OpenCV"
                    ...
                    {/* PostgreSQL */}
                    <div className="absolute -bottom-15 left-1/2 -translate-x-1/2 w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full shadow-xl flex items-center justify-center">
                        <Image
                            alt="PostgreSQL"
